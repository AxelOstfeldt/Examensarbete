...
while DoTests:
    ...
    StartTest = input('Choose Test (1-27), for test info type info, to exit testing type quit: ')
    print("")
    ...
    if StartTest.lower() == 'info':
        ...
        #If it can not be converted to int the user have choosen an invalid value
            ...
            raise ValueError(f"Select an integer between 1-27 for a test or type info for test info")
