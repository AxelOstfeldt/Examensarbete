...
class RiceMeta:
    ...
    def Decode(self, code, kDecode: int = 0):
        ...
        #If kDecode value is not given the first 5 binary values in code represent the kDecode value
        if kDecode == 0:
            k_binary = code[:5]
            kDecode = int(k_binary,2) + 1
            code = code[5:]
